...
function optimal_x_func(μ_0::Float64, μ_0_c::Float64, ω_1::Float64, ω_2::Float64, δ::Float64, γ::Float64, x_T::Float64, ν_1::Float64, ν_2::Float64, α::Float64, ϵ_x::Float64, ϵ_x_p::Float64, ϵ_tol::Float64)
    ...
    set_attribute(model, "max_iter", 6000)
...
PATH_FIG_para_x = mkpath(PATH_FIG * FL * "γ=$(round(BP.γ,digits=1))-μ_0=$(round(BP.μ_0,digits=1))-α=$(round(BP.α,digits=1))" * FL * "communication")
...
PATH_FIG_para_ν = mkpath(PATH_FIG * FL * "γ=$(round(BP.γ,digits=1))-μ_0=$(round(BP.μ_0,digits=1))-α=$(round(BP.α,digits=1))" * FL * "flexibility")
